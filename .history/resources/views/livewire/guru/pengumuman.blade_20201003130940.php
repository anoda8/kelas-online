                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <select class="form-control">
                                            ...
                                            <option value="all" wire:click="ubahKelompok('semua', 'all')">Semua Warga Sekolah</option>
                                            <option value="guru" wire:click="ubahKelompok('semua', 'guru')">Semua Guru</option>
                                            <option value="siswa" wire:click="ubahKelompok('semua', 'siswa')">Semua Siswa</option>
                                        </select>
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control">
                                            ...
                                            @foreach ($jurusans as $jurusan)
                                                <option value="{{ $jurusan->id }}" wire:click="ubahKelompok('jurusan', {{ $jurusan->id }})">{{ $jurusan->tingkat }} - {{ $jurusan->singkat }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control">
                                            ...
                                            @foreach ($kelases as $kelas)
                                                <option value="{{ $kelas->id }}" wire:click="ubahKelompok('kelas', {{ $jurusan->id }})">{{ $kelas->nama }}</option>
                                            @endforeach
                                        </select>
