            ...
            <div class="mb-2 card">
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        ...
                        <button type="button" class="btn btn-warning" wire:click="$emit('triggerSalin', {{ $peng->id }})"><i class="fas fa-copy"></i></button>
                        <button type="button" class="btn btn-info" wire:click="$emit('triggerEdit', {{ $peng->id }})"><i class="fas fa-save"></i></button>
                    </div>
                </div>
            </div>
            @endforeach
