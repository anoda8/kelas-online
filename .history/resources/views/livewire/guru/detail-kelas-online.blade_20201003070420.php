            ...
            <div class="card-hover-shadow-2x mb-3 card">
                ...
                <div class="card-footer">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Tulis komentar.." aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button">Button</button>
                        </div>
                    </div>
                    {{-- <div class="input-group">
                        <input placeholder="Tulis komentar.." style="width:100%;" wire:model.lazy="inputChat" wire:keydown.enter="simpanKomen()" type="text" class="form-control-sm form-control">
                        <div class="input-group-append">
                            <button class="btn btn-success btn-sm"><i class="fas fa-sync"></i></button>
                        </div>
                    </div> --}}
