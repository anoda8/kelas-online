        ...
        <div class="col-md-12">
            ...
            <div class="mb-2 card">
                <div class="card-header-tab card-header bg-light">
                    <div class="card-header-title font-size-lg font-weight-normal text-justify">
                        <b>{{ $peng->judul }}</b>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <button type="button" class="btn btn-danger" wire:click="$emit('triggerHapus', {{ $peng->id }})" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-trash"></i></button>
                        <button type="button" class="btn btn-warning" wire:click="$emit('triggerSalin', {{ $peng->id }})" data-toggle="tooltip" data-placement="top" title="Salin"><i class="fas fa-copy"></i></button>
                        <button type="button" class="btn btn-info" wire:click="$emit('triggerEdit', {{ $peng->id }})" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-pencil-alt"></i></button>
                    </div>
                </div>
            </div>
            @endforeach
