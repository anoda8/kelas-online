                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="form-inline">
                            ...
                            <button class="btn btn-warning ml-2" wire:click="$emit('triggerSalin', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Salin"><i class="fas fa-copy"></i></button>
                            <button class="btn btn-info ml-2" wire:click="$emit('triggerEdit', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-pencil-alt"></i></button>
                        </div>
                    </div>
                </div>
            </div>
