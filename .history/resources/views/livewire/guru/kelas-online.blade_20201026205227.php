                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-5 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='tgl-kelon' wire:ignore.self>
                                        <input type='text' class="form-control" wire:model.lazy="tgl_kelon" />
                                        <span class="input-group-addon">
                                        <span class="fas fa-trash"></span>
                                        </span>
                                     </div>
                                    <input type="date" id="tgl-kelon" class="form-control" >
