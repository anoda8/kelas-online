            ...
            <div class="mb-5 card">
                <div class="card-header-tab card-header">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <button class="btn btn-primary" data-toggle="collapse" href="#collapseTambah" aria-expanded="false" aria-controls="collapseTambah"><i class="fas fa-plus"></i> Tambah</button>
                    </div>
                </div>
