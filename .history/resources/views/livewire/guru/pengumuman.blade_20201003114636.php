                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <select class="form-control" wire:model.lazy="kelompok">
                                            ...
                                            <option value="jurusan">Semua Guru</option>
                                            <option value="kelas">Semua Siswa</option>
                                        </select>
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control" wire:model.lazy="tujuan">
                                            ...
                                            <option value="all" wire:click="setTujuan('all')">Semua Warga Sekolah</option>
                                            <option value="guru" wire:click="setTujuan('guru')">Semua Guru</option>
                                            <option value="siswa" wire:click="setTujuan('siswa')">Semua Siswa</option>
                                        </select>
                                        @error('tujuan') <span class="text-danger error">{{ $message }}</span>@enderror
                                    </div>
                                    @endif
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control" wire:model.lazy="jurusanid">
                                            ...
                                            @foreach ($jurusans as $jurusan)
                                                <option value="{{ $jurusan->id }}" wire:click="setJurusan({{ $jurusan->id }})">{{ $jurusan->tingkat }} - {{ $jurusan->singkat }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control" wire:model.lazy="kelasid">
                                            ...
                                            @foreach ($kelases as $kelas)
                                                <option value="{{ $kelas->id }}" wire:click="setKelas({{ $kelas->id }})">{{ $kelas->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('kelasid') <span class="text-danger error">{{ $message }}</span>@enderror
                                    </div>
                                    @endif
                                </div>{{ $jurusanid }} / {{ $kelasid }} / {{ $tujuan }}<br>
...
document.addEventListener('DOMContentLoaded', ()=>{
    @this.on('triggerSimpan', () => {
        var isipengumuman = CKEDITOR.instances['isipengumuman'].getData();
