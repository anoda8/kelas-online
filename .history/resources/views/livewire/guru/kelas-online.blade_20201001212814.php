            ...
            <div class="mb-3 card">
                ...
                <div wire:ignore.self class="collapse" id="collapseTambah">
                    ...
                    <div class="card-footer">
                        <div class="btn-actions-pane-right text-capitalize">
                            <button class="btn btn-success" wire:click="simpan()"><i class="fas fa-save"></i> Simpan</button>
                        </div>
                    </div>
                </div>
                <div class="card-header-tab card-header">
...
window.livewire.on('postCkEditor', () => {
    CKEDITOR.instances['isimateri'].on('change', function(e){
        @this.set('isimateri', e.editor.getData());
    });
});
