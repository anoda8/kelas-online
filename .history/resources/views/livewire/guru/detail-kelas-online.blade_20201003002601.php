                ...
                <div class="scroll-area-lg">
                    ...
                    <div class="p-2">
                        <div class="chat-wrapper p-1">
                            <div class="p-3 mb-2 bg-primary text-white rounded clearfix">
                                <div class="row">
                                    <div class="col-md-9 text-right">
                                        <span>hai guys bagai mana kali ini kita akan berkata kata apapun yang terjadi kita akan membuat aplikasi ini</span>
                                    </div>
                                    <div class="col-md-3">
