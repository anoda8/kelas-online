            ...
            <div class="mb-2 card">
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        ...
                        <button type="button" class="btn btn-warning" wire:click="$emit('triggerSimpan')"><i class="fas fa-copy"></i>&nbsp;Salin</button>
                        <button type="button" class="btn btn-info" wire:click="$emit('triggerSimpan')"><i class="fas fa-save"></i>&nbsp;Edit</button>
                    </div>
                </div>
            </div>
            @endforeach
