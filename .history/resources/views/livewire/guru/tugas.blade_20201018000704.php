            ...
            <div class="mb-2 card">
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="form-inline">
                            <button wire:ignore.self class="btn btn-danger ml-2" wire:click="$emit('triggerHapus', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-trash"></i></button>
                            <button wire:ignore.self class="btn btn-warning ml-2" wire:click="$emit('triggerSalin', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Salin"><i class="fas fa-copy"></i></button>
                            <button wire:ignore.self class="btn btn-info ml-2" wire:click="$emit('triggerEdit', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-pencil-alt"></i></button>
                        </div>
                    </div>
                </div>
            </div>
