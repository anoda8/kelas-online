        ...
        <div class="col-md-12">
            ...
            <div class="mb-2 card">
                <div class="card-header bg-warning text-white" style="cursor:pointer;">
                    <a href="/guru/kelasonline/detail/{{ $kelon->id }}" style="text-decoration: none;">[{{ $kelon->mapel->nama }}]&nbsp;{{ $kelon->materi }}</a>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="form-inline">
                            ...
                            <button class="btn btn-warning ml-2" wire:click="$emit('triggerSalin', {{ $kelon->id }})"><i class="fas fa-trash"></i> Hapus</button>
