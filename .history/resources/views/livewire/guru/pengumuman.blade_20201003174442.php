        ...
        <div class="col-md-12">
            ...
            <div class="mb-2 card">
                ...
                <div class="pt-1 card-body">
                    ...
                    <hr>
                    <span><b>{{ $peng->author->name }}</b></span><br>
                    <span>
                        @if ($peng->tujuan != null)
                            @switch($peng->tujuan)
                                @case('all')
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <button type="button" class="btn btn-success" wire:click="$emit('triggerSimpan')"><i class="fas fa-save"></i>&nbsp;Hapus</button>
                        <button type="button" class="btn btn-success" wire:click="$emit('triggerSimpan')"><i class="fas fa-save"></i>&nbsp;Salin</button>
                        <button type="button" class="btn btn-success" wire:click="$emit('triggerSimpan')"><i class="fas fa-save"></i>&nbsp;Edit</button>
                    </div>
                </div>
            </div>
            @endforeach
