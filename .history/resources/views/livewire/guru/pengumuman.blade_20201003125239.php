                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <select class="form-control" wire:model.lazy="kelompok">
                                            ...
                                            <option value="semua" wire:click="$emit('ubahKelompok', 'semua')">Semua</option>
                                            <option value="jurusan" wire:click="$emit('ubahKelompok', 'jurusan')">Jurusan</option>
                                            <option value="kelas" wire:click="$emit('ubahKelompok', 'kelas')">Kelas</option>
                                        </select>
