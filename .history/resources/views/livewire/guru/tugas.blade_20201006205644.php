            ...
            <div class="mb-2 card">
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-actions-pane-right">
                        <div class="form-inline">
                            <button class="btn btn-danger ml-2" wire:click="$emit('triggerHapus', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-trash"></i></button>
                            ...
                            <button class="btn btn-info ml-2" wire:click="$emit('triggerEdit', {{ $tugas->id }})" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fas fa-pencil-alt"></i></button>
                        </div>
                    </div>
                </div>
            </div>
