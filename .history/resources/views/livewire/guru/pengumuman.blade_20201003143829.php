    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="mb-2 card">
                ...
                <div class="card-body pl-5 pt-2" style="padding:0;">
                    <span>Pengumuman untuk :
                        @if ($peng->tujuan != null)
                            @switch($peng->tujuan)
                                @case('all')
                                    Semua Warga Sekolah
                    ...
                    <span>Diumumkan pukul : {{ $peng->published_at }}</span><br>
                    <span>Diumumkan oleh : {{ $peng->author->name }}</span>
                    <hr>
                </div>
