                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <select class="form-control" wire:model="tujuan">
                                            ...
                                            <option value="guru" wire:click="ubahKelompok('semua', 'all')">Semua Guru</option>
                                            <option value="siswa" wire:click="ubahKelompok('semua', 'all')">Semua Siswa</option>
                                        </select>
                                    ...
                                    <div class="form-group ml-3">
                                        <select class="form-control" wire:model="kelasid">
                                            ...
                                            @foreach ($kelases as $kelas)
                                                <option value="{{ $kelas->id }}" wire:click="ubahKelompok('jurusan', {{ $jurusan->id }})">{{ $kelas->nama }}</option>
                                            @endforeach
                                        </select>
