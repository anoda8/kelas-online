                ...
                <div class="scroll-area-lg">
                    ...
                    <div class="p-2">
                        <div class="chat-wrapper p-1">
                            <div class="p-3 mb-2 bg-primary text-white text-right">.bg-dark</div>
                            <div class="p-3 mb-2 bg-light text-dark">.bg-dark</div>
                            <div class="p-3 mb-2 bg-primary text-white">.bg-dark</div>
                            <div class="p-3 mb-2 bg-light text-dark">.bg-dark</div>
                            <div class="p-3 mb-2 bg-primary text-white">.bg-dark</div>
                            <div class="p-3 mb-2 bg-light text-dark">.bg-dark</div>
                            <div class="p-3 mb-2 bg-primary text-white">.bg-dark</div>
