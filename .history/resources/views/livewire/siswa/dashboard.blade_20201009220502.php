<div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-header-tab card-header">
                    <div class="card-header-title font-size-lg text-capitalize font-weight-bold"><i class="header-icon fas fa-chalkboard-teacher mr-3 text-muted opacity-6"> </i>Kelas Online Hari Ini {{ date("d/m/Y") }} ({{ $kelon->count() }})
                    </div>
                    <div class="btn-actions-pane-right actions-icon-btn">
                        <div class="btn-group dropdown">
                            <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                ...
                <div class="card-body">
                    <ul class="list-group">
                        @foreach ($data['kelon'] as $kelon)
                            <li class="list-group-item list-group-item-info list-group-item-action mb-2">{{ $kelon->author->name }} - <b>{{ $kelon->materi }}</b> </li>
                        @endforeach
                    </ul>
                </div>
            </div>
