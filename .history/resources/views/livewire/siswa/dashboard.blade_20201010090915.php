                ...
                <div class="card-body">
                    <ul class="list-group">
                        @foreach ($data['kelon'] as $kelon)
                            <li class="list-group-item list-group-item-info list-group-item-action mb-2"><b>
                                {{ $kelon->mapel->nama }} [{{ $kelon->author->name }}]</b> - {{ $kelon->wkt_masuk->format("H:i") }} s/d {{ $kelon->wkt_selesai->format("H:i") }}
                            </li>
                        @endforeach
                    </ul>
                </div>
