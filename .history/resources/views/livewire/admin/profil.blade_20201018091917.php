            ...
            <div class="mb-2 card">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="" {{ (auth()->user()->id == 1) ? "disabled" : "" }} wire:model.lazy="nama">
                                @error('nama') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group">
                                <label for="">Username</label>
                                <input type="text" class="form-control" placeholder="" readonly wire:model="email">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            @if ($fileimport)
                                <img class="img-responsive" src="{{ $fileimport->temporaryUrl() }}" alt="Foto Profil" width="100%">
                            @else
                                @if ($fotoprofil != null)
                                    <img class="img-responsive" src="{{ url($fotoprofil) }}" alt="Foto Profil" width="100%">
                                @else
                ...
                <div class="card-footer">
                    <div class="btn-actions-pane-right">
                        <button type="button" class="btn btn-success" wire:click="simpan">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
