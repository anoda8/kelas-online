                        ...
                        <div class="form-inline">
                            <div class="form-group mr-3 input-group-sm">
                                <div class="form-group" wire:ignore>
                                    <select class="form-control form-control-sm pilih-guru"  wire:model.lazy="katakunciGuru">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:ignore.self class="form-control pilih-guru-tambah" style="width:100%;" wire:model.lazy="guru">
                            <option value="">== Pilih Guru ==</option>
                            @foreach ($gurus as $guru)
                                <option value="{{ $guru->id }}">{{ $guru->nama }}</option>
                            @endforeach
...
$(document).ready(function () {
    $(".pilih-guru").select2();
    $(".pilih-guru").on('change', function(e){
