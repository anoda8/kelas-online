<div>
    ...
    @section('modals')
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="modal-tambah-thajaran" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="firstname">Tambah Tahun</label>
                        <div>
                            <<input type="text" wire:model.lazy="tambah_tahun" class="form-control">
                        </div>
                    </div>

                    <input type="text" wire:model.lazy="tambah_semester" class="form-control">
                    <input type="checkbox" wire:model.lazy="tambah_status" value="1">
                </div>
