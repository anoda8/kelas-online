                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#" class="btn btn-info btn-sm" wire:click.prevent="$emit('triggerCopy', {{ $jurusan->id }})"><i class="fas fa-clone fa-sm"></i></a>
                                    </td>
                                    <td class="text-center">
                                        <a href="#" class="btn btn-danger btn-sm" wire:click.prevent="$emit('triggerDelete', {{ $jurusan->id }})"><i class="fas fa-trash fa-sm"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
document.addEventListener('DOMContentLoaded', ()=>{
    @this.on('triggerCopy', orderId => {
        @this.call('copy', orderId);
        $('#modal-jurusan').modal('toggle');
    });
});
document.addEventListener('DOMContentLoaded', ()=>{
