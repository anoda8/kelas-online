                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @foreach ($kelases as $kelas)
                                <button class="btn {{ array_search($kelas->id, $kelasid, true) ? "btn-danger" : "btn-dark" }} ml-2 mr-2 mb-2 mt-2" wire:click="collectKelas({{ $kelas->id }})">{{ $kelas->id }} {{ $kelas->nama }}</button>
                            @endforeach
                        </div>
                        <div class="alert alert-warning ml-3 mt-2">
                            <div class="text-danger">Data yang anda pilih akan mengubah ulang semua data mapel yang ada di data pembelajaran</div>
                        </div>
                    </div>
                </div>
