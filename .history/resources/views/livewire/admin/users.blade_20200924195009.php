                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text"
                        ...
                        <small id="namaLengkap" class="form-text text-muted">Help text</small>
                    </div>
                    <div class="form-group">
                      <label for="username">Username / NIK / NIP</label>
                      <input type="text"
                        class="form-control" name="username" id="username" aria-describedby="userName" placeholder="Username / NIK / NIP">
                      <small id="userName" class="form-text text-muted">Help text</small>
                    </div>
                </div>
