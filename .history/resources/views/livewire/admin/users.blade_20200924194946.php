            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" wire:model.lazy="nama" aria-describedby="helpId" placeholder="Nama Lengkap">
                        <small id="helpId" class="form-text text-muted">Help text</small>
                    </div>
                    <div class="form-group">
                      <label for="">Username / NIK / NIP</label>
                      <input type="text"
                        class="form-control" name="" id="" aria-describedby="helpId" placeholder="Username / NIK / NIP">
                      <small id="helpId" class="form-text text-muted">Help text</small>
                    </div>
                </div>
