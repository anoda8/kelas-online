                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <div class="form-inline">
                            <div class="form-group input-group-sm">
                                <input type="text" class="form-control ml-2" placeholder="Cari Mapel">
                                <input type="text" class="form-control ml-2" placeholder="Cari Guru">
                                <input type="text" class="form-control ml-2" placeholder="Cari Kelas">
                            </div>
                        </div>
                    </div>
                </div>
