                ...
                <div class="card-header-tab card-header">
                    ...
                    <div class="btn-actions-pane-right text-capitalize">
                        <div class="form-inline input-group-sm">
                            ...
                            <a type="button" class="mr-2 btn btn-warning" wire:click="$emit('showImportForm')" />
                                <i class="fas fa-download"></i> Impor
                            </a>
                            <a type="button" class="mr-2 btn btn-success" href="{{ '/'.request()->path().'/export' }}" />
                                <i class="fas fa-download"></i> Ekspor
                            </a>
                            <button type="button" class="btn btn-primary" wire:click="$emit('showAddForm')" />
