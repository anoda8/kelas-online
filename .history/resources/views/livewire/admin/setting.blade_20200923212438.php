<div>
    ...
    <!-- Modal -->
    <div class="modal" id="modal-tambah-thajaran" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="z-index: 9999;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Modal Tambah Tahun Pelajaran</h5>
