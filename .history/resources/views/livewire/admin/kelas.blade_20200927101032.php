                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="list-group">
                                @foreach ($carisiswa as $siswa)
                                    <li class="list-group-item" style="cursor:pointer;background-color:lightgreen;"><b>{{ $siswa->nis }} || {{ $siswa->nama }}</b> => <i>[{{ $siswa->jenkel ? "Perempuan" : "Laki-laki" }}, {{ $siswa->tgl_lahir }}]</i></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
