                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('admin.data.pembelajaran')}}" class="{{ request()->path() == "admin/data/pembelajaran" ? "mm-active" : ""}}">
                                            <i class="metismenu-icon">
                                            </i>Pembelajaran
                                        </a>
                                    </li>
                            ...
                            <li class="app-sidebar__heading">BUKU PANDUAN</li>
                            <li>
                                <a href="{{ route('admin.panduan') }}">
                                    <i class="metismenu-icon fas fa-book"></i>
                                    Panduan Penggunaan
                                </a>
                                <a href="{{ route('admin.perubahan') }}">
