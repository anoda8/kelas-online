...
Route::group(['prefix' => 'admin', 'middleware' => ['role:admin']], function () {
    ...
    Route::get('/perubahan', App\Http\Livewire\Admin\Perubahan::class)->name('admin.perubahan');
});
...
Route::group(['prefix' => 'siswa', 'middleware' => ['role:siswa']], function () {
    ...
    Route::get('/profil', App\Http\Livewire\Siswa\Profil::class)->name('siswa.profil');
});
