...
class DetailKelasOnline extends Component
{
    ...
    public function render()
    {
        ...
        $kelasAktif = LogKelasOnline::where('kelon_id', $this->kelonid)->where('user_id', Auth::id())->where('status', true)->get();
        ...
        return view('livewire.siswa.detail-kelas-online', [
            'kelas' => $kelas, 'komentare' => $this->komentar, 'kelasAktif' => $kelasAktif
        ]);
    }
