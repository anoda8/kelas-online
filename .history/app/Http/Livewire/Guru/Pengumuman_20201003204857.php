...
class Pengumuman extends Component
{
    ...
    public $editId = null;
    public $kataKunciPeng, $kataKunciTgl;
    ...
    public function render()
    {
        ...
        $pengumuman = ModelsPengumuman::where('author_id', Auth::id())->orWhere('published_at', $this->kataKunciTgl)
        ->where('judul', 'like', '%'.$this->kataKunciPeng.'%')->with(['author', 'kelas'])->get();
