...
class Tugas extends Component
{
    ...
    public function render()
    {
        ...
        $tugas = ModelsTugas::where('author_id', Auth::id())->with(['mapel', 'kelas', 'author', 'respon'])->paginate($this->perpage);
        ...
        if ($this->kataKunciTgl != null) {
            $this->kataKunciJudul = $this->kataKunciKelas = null;
            $tugas = ModelsTugas::where('author_id', Auth::id())->where('created_at', $this->kataKunciKelas)->with(['mapel', 'kelas', 'author'])->paginate($this->perpage);
        }
