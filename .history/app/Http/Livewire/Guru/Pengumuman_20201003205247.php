...
class Pengumuman extends Component
{
    ...
    public $editId = null;
    public $kataKunciPeng, $kataKunciTgl = null;
    ...
    public function render()
    {
        ...
        $pengumuman = ModelsPengumuman::where('author_id', Auth::id())->where('judul', 'like', '%'.$this->kataKunciPeng.'%')->with(['author', 'kelas'])->get();
        if($this->kataKunciTgl != null){
            $pengumuman = ModelsPengumuman::where('author_id', Auth::id())->whereDate('published_at', '=', $this->kataKunciTgl)->with(['author', 'kelas'])->get();
        }
